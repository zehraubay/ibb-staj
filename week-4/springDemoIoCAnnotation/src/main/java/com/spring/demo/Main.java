...
public class Main {
    public static void main(String[] args) {
        ...
        // AnnocationConfigApplicationContext context = new AnnocationConfigApplicationContext(IocConfig.class); //burada xml dosyamızı okuyacağımızı söylüyoruz
        //ilgili config dosyasına gidecek sonra, componentscan olarak com.springdemo daki tüm  class'ları arıyacak database için

        // context.refresh();
        //ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("pom.xml"); //burada xml dosyamızı okuyacağımızı söylüyoruz

       // ICustomerDal customerDal = context.getBean("database", ICustomerDal.class); //ICustomerDal için database de ne yazıyorsa onu new'le ver demek
...
<context :component-scan base-package="com.springdemo"></context:component-scan> //bu paketteki her şeyi tarayacak
